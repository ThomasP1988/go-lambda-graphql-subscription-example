...
var rights awsiam.PolicyStatement
...
func NewInfraStack(scope constructs.Construct, id string, props *InfraStackProps) awscdk.Stack {
	...
	SetEndpoints(stack)
	SetEventsTable(stack)
	SetSubscriptionsTable(stack)

	SetConnectionsTable(stack)
	SetWebsocketEndpoint(stack)
...
func main() {
	...
	NewInfraStack(app, "GoLambdaGraphQLSubscriptionExample", &InfraStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
